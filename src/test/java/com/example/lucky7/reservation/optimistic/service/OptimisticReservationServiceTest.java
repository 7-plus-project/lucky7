...
class OptimisticReservationServiceTest {
    ...
    @BeforeEach
    public void setup() {
        OptimisticReservation reservation = new OptimisticReservation(100);
        OptimisticReservation savedReservation = optimisticReservationService.saveReservation(reservation);
        optimisticReservationId = savedReservation.getId();
    }
