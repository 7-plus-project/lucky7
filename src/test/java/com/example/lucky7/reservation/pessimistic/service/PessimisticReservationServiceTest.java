package com.example.lucky7.reservation.pessimistic.service;

import com.example.lucky7.domain.reservation.pessimistic.entity.PessimisticReservation;
import com.example.lucky7.domain.reservation.pessimistic.service.PessimisticReservationService;
...
class PessimisticReservationServiceTest {
    ...
    public void testPessimisticLock() throws InterruptedException {
        ...
        assertEquals(100, successfulUpdates.get(), "정확히 100명만 예약되어야 합니다.");
