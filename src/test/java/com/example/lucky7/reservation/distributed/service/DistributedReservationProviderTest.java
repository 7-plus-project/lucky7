package com.example.lucky7.reservation.distributed.service;

import com.example.lucky7.domain.reservation.distributed.entity.DistributedReservation;
import com.example.lucky7.domain.reservation.distributed.service.DistributedReservationProvider;
import com.example.lucky7.domain.reservation.distributed.service.DistributedReservationService;
...
class DistributedReservationProviderTest {
    ...
    public void testDistributedLock() throws InterruptedException {
        ...
        assertTrue(successfulUpdates.get() <= 100, "100명까지만 예약 성공해야 합니다.");
